...
Ce projet présente quelques exemples basiques de l'utilisation du plugin jQuery DataTable.
Ce plugin permet de créer un tableau triable facilement.
Plein d'options sont disponible pour le personnaliser.